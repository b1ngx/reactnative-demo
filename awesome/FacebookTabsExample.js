...
const FacebookTabsExample = React.createClass({
  render() {
    return <View style={styles.container}>
      <ScrollableTabView initialPage={0} renderTabBar={() => <FacebookTabBar />} tabBarPosition='bottom'>
...
const SimpleExample = React.createClass({
  render() {
    return <ScrollableTabView style={{marginTop: 0, }} tabBarPosition='bottom'>
...
const ScrollableTabsExample = React.createClass({
  render() {
    return <View style={styles.container}>
      <ScrollableTabView initialPage={0} tabBarPosition={'bottom'} renderTabBar={() => <ScrollableTabBar />}>
        <Text tabLabel='Tab #1'>My</Text>
